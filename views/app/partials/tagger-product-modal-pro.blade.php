<div id="TaggerProduct" style="display: block; float: left; margin-right: 20px;">
    <div class="modal-dialog" style="width: 300px; margin-top: 0px;">
	  ...
	  border-radius: 3px 3px 3px 3px; box-shadow: none; border: 3px; border-style: solid;">
			...
			<p align="justify"><iframe width="270" height="152" src="https://www.youtube-nocookie.com/embed/Sh0qSJRo4Aw?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe></p>
				...
				<p align="justify"><b>5.</b> Um eine weitere Bildbeschreibung zu erstellen, klicken Sie auf eine andere Stelle im Bild.</p><br>
                    ...
                    <div class="tab-pane active" id="create-product">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" id="input-description"
                                      placeholder="Beschreibung (max. 500 Zeichen)" maxlength="500" style="height: 150px;" required></textarea>
                        </div>
                        <div class="form-group">
